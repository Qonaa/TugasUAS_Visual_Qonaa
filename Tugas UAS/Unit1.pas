...
if edt1.Text = '' then
  ...
  else if not DataModule2.zqry1.Locate('nik', edt1.Text, []) then
  begin
...
begin
  edt1.Text := DataModule2.zqry1.FieldByName('nik').AsString;
  edt2.Text := DataModule2.zqry1.FieldByName('nama').AsString;
  edt3.Text := DataModule2.zqry1.FieldByName('telp').AsString;
  edt4.Text := DataModule2.zqry1.FieldByName('email').AsString;
  edt5.Text := DataModule2.zqry1.FieldByName('alamat').AsString;
  cbb1.Text := DataModule2.zqry1.FieldByName('member').AsString;
...
begin
 // Aktifkan komponen input
  ...
  edt4.Text := '';
  edt5.Text := '';
  cbb1.ItemIndex := 0; // Pilih default 'yes'

  edt1.SetFocus; // Set focus ke input Nik
end;
